...
;ZERO PAGE STORAGE
;
ptr01    = RES                  ;input string pointer
stridx   = ptr01+2              ;string index
pfac     = TR0                  ;primary accumulator
...
;
.proc atoi32
    ;;@brief convert a string into 32 bits integer
    ;;@inputX Low ptr string
    ;;@inputy High ptr string
    ;;@modifyMEM_TR0
    ;;@modifyMEM_TR1
    ;;@modifyMEM_TR2
    ;;@modifyMEM_TR3
    ;;@modifyMEM_RES
    ;;@returnsMEM_TR0 ; 32 bits number
    ;;@returnsMEM_TR1 ; 32 bits number
    ;;@returnsMEM_TR2 ; 32 bits number
    ;;@returnsMEM_TR3 ; 32 bits number
;
strbin:
...
strbin04:
    lda     #10         ;number bases table
    sta     valdnum           ;set valid numeral range
    lda     #$03         ;get bits per digit
    sta     bitsdig           ;store
...
bitsdig:
    .res 1                 ;bits per digit
curntnum:
    .res 1                 ;numeral being processed
radxflag:
    .res 1                 ;$80 = processing base-10
valdnum:
    .res 1                 ;valid range +1 for selected radix
;
;================================================================================
.endproc
